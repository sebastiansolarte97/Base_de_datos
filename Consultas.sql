...
1.	SELECT e.id_estado,e.materias,e.nota,e.grado, e.id_estudiante, p.nombre_est, p.apellido_est,p.curso  FROM estado_academico e inner join estudiante p on e.id_estudiante=p.id_estudiante
